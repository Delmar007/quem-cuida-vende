...
const target2 = `<div style={{ color: '#ea580c', fontWeight: '600' }}>{matchData.request.proprietarioTelefone}</div>`;
const replace2 = `<div style={{ color: '#ea580c', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
...
const target3 = `<div style={{ color: '#0284c7', fontWeight: '600' }}>{car.proprietarioTelefone}</div>`;
const replace3 = `<div style={{ color: '#0284c7', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
...
console.log('Admin.jsx whatsapp link added to matches');
